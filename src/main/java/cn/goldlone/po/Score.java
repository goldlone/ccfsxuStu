...
public class Score {
    ...
    public Score(ImportScore score, int certNo, String memberNo) {
        this.certNo = certNo;
        this.memberNo = memberNo;
        this.all = score.getAll();
        this.first = score.getFirst();
        this.second = score.getSecond();
        this.third = score.getThird();
        this.forth = score.getForth();
        this.fifth = score.getFifth();
    }
